...
@Component({
  selector: "app-daliy-report-page",
  templateUrl: "./daliy-report-page.component.html",
  styleUrls: ["./daliy-report-page.component.css"]
})
export class DaliyReportPageComponent implements OnInit {
  date: Date = new Date();
